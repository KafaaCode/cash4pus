                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control"
                                        value="<?php echo e(old('title', $bank->title)); ?>" placeholder="<?php echo app('translator')->get('banks.title'); ?>">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="minimum_payment" class="form-control"
                                        value="<?php echo e(old('minimum_payment', $bank->minimum_payment)); ?>"
                                        placeholder="<?php echo app('translator')->get('banks.minimum_payment'); ?>" step="0.01" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="limit_payment" class="form-control"
                                        value="<?php echo e(old('limit_payment', $bank->limit_payment)); ?>"
                                        placeholder="<?php echo app('translator')->get('banks.limit_payment'); ?>" step="0.01" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fee_percentage" class="form-control"
                                        value="<?php echo e(old('fee_percentage', $bank->fee_percentage)); ?>"
                                        placeholder="<?php echo app('translator')->get('banks.fee_percentage'); ?>" step="0.01" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" class="form-control"
                                        value="<?php echo e(old('address', $bank->address)); ?>" placeholder="<?php echo app('translator')->get('banks.address'); ?>">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="is_active" class="form-control">
                                        <option value="1" <?php echo e(old('is_active', $bank->is_active) == 1 ? 'selected' : null); ?>>
                                            <?php echo e(__('Active')); ?></option>
                                        <option value="0" <?php echo e(old('is_active', $bank->is_active) == 0 ? 'selected' : null); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Freelancer\Asmar Market\public_html_downlaod\resources\views/admin/banks/edit.blade.php ENDPATH**/ ?>