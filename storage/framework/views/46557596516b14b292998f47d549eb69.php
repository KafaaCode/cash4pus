                            ...
                            <table class="table table-bordered align-middle nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col"><?php echo app('translator')->get('banks.image'); ?></th>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <th scope="row">
                                                <?php if($bank->image): ?>
                                                    <img src="<?php echo e(asset('uploads/banks/' . $bank->image)); ?>" alt="bank image" width="50">
                                                <?php else: ?>
                                                    —
                                                <?php endif; ?>
                                            </th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Freelancer\Asmar Market\public_html_downlaod\resources\views/admin/banks/index.blade.php ENDPATH**/ ?>