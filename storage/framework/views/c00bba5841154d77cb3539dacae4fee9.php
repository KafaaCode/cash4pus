...
<?php $__env->stopSection(); ?>
                                    ...
                                    <li class="col-4 pr-0 pl-0">
                                        <?php if($category->active): ?>
                                            <a href="<?php echo e(route('front.game.category', $category->id)); ?>"
                                                ...
                                                <div class="name_wrp"
                                                    style="background-image:url('<?php echo e(asset('uploads/categories/' . $category->image)); ?>');">
                                                    <div class="icon">
                                                        <img src="<?php echo e(asset('uploads/categories/' . $category->image)); ?>"
                                                            alt="<?php echo e($category->name); ?>" width="90">
                                                    </div>
                                                </div>
                                                <span class="d-block mt-2 mb-2"><?php echo e($category->name); ?></span>
                                            </a>
                                        <?php else: ?>
                                            <a href="<?php echo e('javascript:void(0)'); ?>"
                                                class="product_group <?php if(!$category->active || $category->games->count() == 0): ?> disabled <?php endif; ?>"
                                                data-group="soulchill">
                                                <div class="name_wrp"
                                                    style="background-image:url('<?php echo e(asset('uploads/categories/' . $category->image)); ?>');">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Freelancer\Asmar Market\public_html_downlaod\resources\views/front/index.blade.php ENDPATH**/ ?>