    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo e(route('ad.transactions.update',$transaction->id)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="invoice_no" class="form-control" value="<?php echo e(old('invoice_no',$transaction->invoice_no)); ?>" placeholder="<?php echo app('translator')->get('transactions.invoice_no'); ?>" >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="account_number" class="form-control" value="<?php echo e(old('account_number',$transaction->account_number)); ?>" placeholder="<?php echo app('translator')->get('transactions.account_number'); ?>" >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="account_name" class="form-control" value="<?php echo e(old('account_name',$transaction->account_name)); ?>" placeholder="<?php echo app('translator')->get('transactions.account_name'); ?>" >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_at" class="form-control" value="<?php echo e(old('date_at',$transaction->date_at->format('Y-m-d'))); ?>" placeholder="<?php echo app('translator')->get('transactions.date_at'); ?>" >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <input type="hidden" value="<?php echo e($transaction->status); ?>" name="status" >
                            <input type="hidden" value="<?php echo e($transaction->reason); ?>" name="reason" >
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="bank_id" class="form-control">
                                        ...
                                        <option value="<?php echo e($bank->id); ?>" <?php echo e(old('bank_id',$transaction->bank?->id)==$bank->id?'selected':null); ?>>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="user_id" class="form-control">
                                        ...
                                        <option value="<?php echo e($user->id); ?>" <?php echo e(old('user_id',$transaction->user?->id)==$user->id?'selected':null); ?>>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="currency_id" class="form-control">
                                        ...
                                        <option value="<?php echo e($currency->id); ?>" <?php echo e(old('currency_id',$transaction->currency->id)==$currency->id?'selected':null); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="final_total" class="form-control" value="<?php echo e(old('final_total',$transaction->final_total)); ?>" placeholder="<?php echo app('translator')->get('transactions.final_total'); ?>" >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="details" class="form-control">
                                       <?php echo old('details',$transaction->details); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u187789736/domains/asmar-card.com/public_html/resources/views/admin/transactions/edit.blade.php ENDPATH**/ ?>