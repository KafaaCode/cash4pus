                                ...
                                <tbody>
                                    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <th scope="row"><?php echo e($transaction->user?->name); ?></th>
                                            ...
                                            <th scope="row"> <?php echo e($transaction->final_total); ?></th>
                                            <th scope="row">
                                                <?php if($transaction): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\1-projects\2-Sherif-shalaby\mobile-shop\mobile.code.shop\resources\views/admin/transactions/index.blade.php ENDPATH**/ ?>