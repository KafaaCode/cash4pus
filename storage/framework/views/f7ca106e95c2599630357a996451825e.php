...
<?php if($order->status == 'pending'): ?>
 <a href="<?php echo e(route('ad.orders.change_status', encrypt($order->id))); ?>"
        title="<?php echo e(__('change')); ?> <?php echo e(trans('approved')); ?>">
    ...
    <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
        data-bs-target="#change<?php echo e($order->id); ?>" title="<?php echo app('translator')->get('Cancel Order'); ?>">
...
<?php /**PATH D:\Personal\Freelancer\Asmar Market\public_html_downlaod\resources\views/admin/orders/action.blade.php ENDPATH**/ ?>