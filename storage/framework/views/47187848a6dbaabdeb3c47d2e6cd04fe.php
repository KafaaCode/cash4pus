        ...
        <div class="d-flex">
            ...
            <?php if(auth()->guard('web')->check()): ?>
                <a href="<?php echo e(route('front.transactions.create')); ?>" class="alert alert-success pull-left mt-3 ml-2 mr-3" style="margin: 0 20px;margin-bottom:0;max-height:38px;padding-top:0.3rem;font-size:1.2em;color:#155724">
                    <strong class=""><?php echo e(get_helper_price(auth()->user()->my_balance,true)); ?></strong>
                </a>
...
<?php endif; ?>
<?php /**PATH D:\1-projects\2-Sherif-shalaby\mobile-shop\mobile.code.shop\resources\views/front/layouts/topbar.blade.php ENDPATH**/ ?>