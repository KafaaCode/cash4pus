...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('ad.providers.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="api_url" class="form-control" value="<?php echo e(old('api_url')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="api_key" class="form-control" value="<?php echo e(old('api_key')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="api_endpoints" class="form-control"><?php echo e(old('api_endpoints')); ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="is_active" class="form-control">
                                        <option value="1" <?php echo e(old('is_active') == 1 ? 'selected' : ''); ?>><?php echo e(__('common.active')); ?></option>
                                        <option value="0" <?php echo e(old('is_active') == 0 ? 'selected' : ''); ?>><?php echo e(__('common.inactive')); ?></option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-plus"></i> <?php echo e(__('common.save')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u187789736/domains/zain-market.com/public_html/resources/views/admin/providers/create.blade.php ENDPATH**/ ?>