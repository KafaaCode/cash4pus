...
unset($__errorArgs, $__bag); ?>
                    ...
                    <input type="hidden" id="qty_item" name="qty_item"  value="<?php echo e($game->have_packages ? 0 : $game->min_qty); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-6">
                        <label for="total"><?php echo e(__('translation.total')); ?></label>
                        <input name="total" value="<?php echo e($game->price_qty); ?>" class="form-control" id="total" type="number" disabled >
                        <input name="price_item" value="<?php echo e($game->price_qty); ?>" class="form-control" id="price_item" type="hidden"  >
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\D-sherif\game-shop\resources\views/front/games/show.blade.php ENDPATH**/ ?>