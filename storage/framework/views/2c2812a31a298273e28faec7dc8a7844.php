    ...
    <div data-simplebar class="h-100">
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <?php if(auth()->user()->hasPermission('read_settings')): ?>
                <li>
                    <a href="<?php echo e(route('ad.advertisements')); ?>" >
                        <i class="fa fa-cogs"></i>
                ...
                <?php if(auth()->user()->hasPermission('read_games')): ?>
                <li>
                    <a href="<?php echo e(route('ad.categories.index')); ?>" >
                        <i class="fa fa-subway"></i>
                        <span key="t-dashboards"><?php echo e(__('categories.categories')); ?></span>
                    </a>
                </li>
                <?php endif; ?>
                ...
                <?php endif; ?>
                                <?php if(auth()->user()->hasPermission('read_orders')): ?>
                <li>
                    <a href="<?php echo e(route('ad.finance.index')); ?>" >
                        <i class="fa fa-id-card"></i>
                ...
                <?php endif; ?>
                <?php if(auth()->user()->hasPermission('read_providers')): ?>
                <li>
                    <a href="<?php echo e(route('ad.providers.index')); ?>" >
                        <i class="fa fa-user"></i>
                        <span key="t-dashboards"><?php echo e(__('providers.providers')); ?></span> 
                </li>
                <?php endif; ?>
...
<!-- Left Sidebar End -->
<?php /**PATH D:\Personal\Freelancer\Asmar Market\public_html_downlaod\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>