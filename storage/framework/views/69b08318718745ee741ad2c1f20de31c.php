...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row mb-3">
        <div class="col-md-12 d-flex justify-content-between align-items-center">
            <div>
                <a href="<?php echo e(route('front.finance.user-index', ['type' => 'in'])); ?>"
                    class="btn btn-success <?php echo e($type == 'in' ? 'active' : ''); ?>">الوارد</a>
                <a href="<?php echo e(route('front.finance.user-index', ['type' => 'out'])); ?>"
                    class="btn btn-danger <?php echo e($type == 'out' ? 'active' : ''); ?>">الصادر</a>
            </div>

            <form method="GET" action="<?php echo e(route('front.finance.user-index')); ?>" class="form-inline">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u187789736/domains/asmar-card.com/public_html/resources/views/front/finance/index.blade.php ENDPATH**/ ?>