                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            ...
                            <?php if(auth()->user()->hasPermission('update_users')): ?>
                                <form action="<?php echo e(route('ad.users.resetBalances')); ?>" method="POST" style="display:inline;" id="withdrawForm">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <th scope="row">
                                                ...
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('no-image.jpg')); ?>" style="width: 50px;"
                                                        alt="<?php echo e($user->name); ?> ">
                                                <?php endif; ?>
                                            </th>
                                            ...
                                            <th scope="row">
                                                <a href="https://wa.me/<?php echo e($user->whats_app); ?>?text=" target="_blank"
                                                    title="<?php echo e($user->whats_app); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u187789736/domains/asmar-card.com/public_html/resources/views/admin/users/index.blade.php ENDPATH**/ ?>