                                    ...
                                    <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="col-xl-2 col-5 pr-0 pl-0">
                                            <a href="<?php echo e(route('front.transactions.stepTwo',$bank->id)); ?>" class="payment_gateway">
                                                <div class="name_wrp" style="background-image:url('<?php echo e(asset('images/icons/background.jpg')); ?>');">
                                                    <div class="icon">
                                                        <div>
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u187789736/domains/asmar-card.com/public_html/resources/views/front/transactions/create.blade.php ENDPATH**/ ?>