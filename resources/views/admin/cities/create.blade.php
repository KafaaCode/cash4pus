    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('ad.cities.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('cities.country')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('cities.is_active')<span class="text-danger">*</span></label>
