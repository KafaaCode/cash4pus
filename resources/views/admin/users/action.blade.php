...
<a href="{{ route('ad.users.edit', $user->id) }}" class="btn btn-warning btn-sm" title="@lang('Edit')"><i
...
<div class="modal fade" id="delete{{ $user->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('ad.users.destroy', $user->id) }}" method="POST">
                <div class="modal-body">
                    @csrf
                    @method('delete')
                    <p> @lang('Delete') <span>{{ $user['name'] }}</span> </p>
                </div>
