    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('ad.transactions.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="invoice_no" class="form-control" value="{{ old('invoice_no') }}" placeholder="@lang('transactions.invoice_no')" >
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="account_number" class="form-control" value="{{ old('account_number') }}" placeholder="@lang('transactions.account_number')" >
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="account_name" class="form-control" value="{{ old('account_name') }}" placeholder="@lang('transactions.account_name')" >
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_at" class="form-control" value="{{ old('date_at') }}" placeholder="@lang('transactions.date_at')" >
                            ...
                            {{-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="pending" {{ old('status') == 'pending' ? 'selected' : null }}>{{ __('pending') }}</option>
                                        <option value="approved" {{ old('status') == 'approved' ? 'selected' : null }}>{{ __('approved') }}</option>
                                        <option value="canceled" {{ old('status') == 'canceled' ? 'selected' : null }}>{{ __('canceled') }}</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="currency_id" class="form-control">
                                        ...
                                        <option value="{{ $currency->id }}" {{ old('currency_id')==$currency->id?'selected':null }}>
                                                {{ $currency->currency }}
                                        </option>
                                        @empty
                                        @endforelse
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="final_total" class="form-control" value="{{ old('final_total') }}" placeholder="@lang('transactions.final_total')" >
